...
TEST(PartOfSpeechWordLayerTest, TestBackwardCpu) {
  ...
  // EXPECT_FLOAT_EQ(0.0f, word_input.difference(2));
  ...
  // EXPECT_FLOAT_EQ(0.0f, word_input.difference(6));
  // EXPECT_FLOAT_EQ(0.0f, word_input.difference(7));
  ...
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(1, 0));
  ...
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(9, 0));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(0, 1));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(1, 1));
  ...
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(9, 1));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(0, 2));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(1, 2));
  ...
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(9, 2));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(0, 3));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(1, 3));
  ...
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(9, 3));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(0, 4));
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(1, 4));
  ...
  // EXPECT_FLOAT_EQ(0.0f, classify_weights.difference(9, 4));

  // EXPECT_FLOAT_EQ(0.0f, classify_bias.difference(0));
  // EXPECT_FLOAT_EQ(0.0f, classify_bias.difference(1));
  // EXPECT_FLOAT_EQ(0.0f, classify_bias.difference(2));
  // EXPECT_FLOAT_EQ(0.0f, classify_bias.difference(3));
  // EXPECT_FLOAT_EQ(0.0f, classify_bias.difference(4));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(12, 1));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(16, 1));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(16, 2));
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(17, 2));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(1, 3));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(16, 3));
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(17, 3));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(16, 5));
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(17, 5));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(1, 6));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(16, 6));
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(17, 6));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(16, 8));
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(17, 8));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(1, 9));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(16, 9));
  // EXPECT_FLOAT_EQ(0.0f, combine_weights.difference(17, 9));
  ...
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(1));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(2));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(3));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(4));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(5));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(6));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(7));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(8));
  // EXPECT_FLOAT_EQ(0.0f, combine_bias.difference(9));
}
